...
public class DTE_Submit_Test extends BaseTest{
	String RunName = ExtentManager.getRunName();
	String CreatedBy = ExtentManager.getCreatedBy();
	String skip = "";
	private final Logger logger = Logger.getLogger(DTE_Submit_Test.class.getName());
	
	@BeforeTest
	public void init(){
		suitename= "exampletestsuite_dtesuite";
		testname = "DTE_Submit_Test";
		xls = new Xls_Reader(Constants.DTESUITE_XLS);
	}
		 
	 @Test(dataProvider="getData")
	 public void DTEVerifyTest(Hashtable<String,String>data) throws IOException, SQLException{
